...
function Home() {
  ...
  <main className="mx-auto w-full px-4 py-2">
    <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-blue-600 to-emerald-500 p-6 text-white shadow-xl">
        
        <div className="absolute -right-16 -top-14 h-48 w-48 rounded-full bg-emerald-300/30 blur-3xl" />
        ...
        <h1 className="mt-2 text-3xl font-bold leading-tight sm:text-4xl">
          Discover Trends. Grab the Best Prices. Shop Without Limits.
        </h1>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button className="rounded-full bg-emerald-400 px-5 py-2 text-sm font-semibold text-black hover:bg-emerald-300 transition">
            Shop Deals
          </button>

          <button className="rounded-full border border-white/40 px-5 py-2 text-sm font-semibold hover:bg-white/10 transition">
            View Categories
          </button>
        </div>
